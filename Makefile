...
ifeq ($(UNAME), x86_64)
	...
	TOOLCHAIN?=/home/noblemo/nfs/tiny6410/tools/arm-gnu-toolchain-13.2.Rel1-x86_64-arm-none-eabi/bin/arm-none-eabi-
...
ifeq ($(hw), rpi2)
	...
	#CFLAGS    = -march=armv7-a -mtune=cortex-a7 -fno-pic -fno-pie -fno-stack-protector -static -fno-builtin -fno-strict-aliasing -Wall -I include
	#CFLAGS    = -ffreestanding -nostdlib -nostartfiles -O2 -Wall -MD -ggdb -Wall -mcpu=cortex-a7 -mfloat-abi=hard -fno-short-enums -I include 
	CFLAGS    = -ffreestanding -nostdlib -nostartfiles -O2 -Wall -MD -ggdb -Wall -mcpu=cortex-a7 -mfloat-abi=hard -mfpu=vfpv3-d16 -fno-short-enums -I include 
	TARGET    = kernel7.bin
	CC_OPTIONS = -DRPI2
else
