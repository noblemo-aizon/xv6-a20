...
#define AW_CCM_BASE      0x000020000

//#define SUNXI_UART0_BASE  0x01C28000
#define SUNXI_UART0_BASE    0x000028000


#define CONFIG_CONS_INDEX  1
#define APB0_GATE    (AW_CCM_BASE + 0x068)
...
#define UART0_USR (SUNXI_UART0_BASE + 0x7C)   /* Uart status register */
