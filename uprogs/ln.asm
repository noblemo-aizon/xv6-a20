...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
    ...
    printf(2, "Usage: ln old new\n");
      20:	e30110d8 	movw	r1, #4312	@ 0x10d8
      24:	e3401000 	movt	r1, #0
      28:	e3a00002 	mov	r0, #2
      2c:	eb0002b9 	bl	b18 <printf>
    exit();
      30:	eb000127 	bl	4d4 <exit>
  }
  if(link(argv[1], argv[2]) < 0)
    ...
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
      ...
      7c:	e30110ec 	movw	r1, #4332	@ 0x10ec
      80:	e3401000 	movt	r1, #0
      84:	e3a00002 	mov	r0, #2
      88:	eb0002a2 	bl	b18 <printf>
  exit();
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    buf[i++] = digits[x - y * b];
     ...
     a78:	e3013108 	movw	r3, #4360	@ 0x1108
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     c4c:	1a00000b 	bne	c80 <printf+0x168>
          s = "(null)";
     c50:	e3013100 	movw	r3, #4352	@ 0x1100
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     d6c:	e3013124 	movw	r3, #4388	@ 0x1124
  ...
  freep = p;
     eb0:	e3013124 	movw	r3, #4388	@ 0x1124
...
morecore(uint nu)
{
  ...
  return freep;
     f40:	e3013124 	movw	r3, #4388	@ 0x1124
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     f7c:	e3013124 	movw	r3, #4388	@ 0x1124
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    105c:	e5832004 	str	r2, [r3, #4]
      ...
      freep = prevp;
    1060:	e3013124 	movw	r3, #4388	@ 0x1124
    ...
    if(p == freep)
    107c:	e3013124 	movw	r3, #4388	@ 0x1124
