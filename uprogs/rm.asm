...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    buf[i++] = digits[x - y * b];
     ...
     a9c:	e3013134 	movw	r3, #4404	@ 0x1134
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     d90:	e3013150 	movw	r3, #4432	@ 0x1150
  ...
  freep = p;
     ed4:	e3013150 	movw	r3, #4432	@ 0x1150
...
morecore(uint nu)
{
  ...
  return freep;
     f64:	e3013150 	movw	r3, #4432	@ 0x1150
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     fa0:	e3013150 	movw	r3, #4432	@ 0x1150
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1080:	e5832004 	str	r2, [r3, #4]
      ...
      freep = prevp;
    1084:	e3013150 	movw	r3, #4432	@ 0x1150
    ...
    if(p == freep)
    10a0:	e3013150 	movw	r3, #4432	@ 0x1150
